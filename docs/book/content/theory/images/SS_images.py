"""
------------------------------------------------------------------------
This script creates the plots for the steady-state chapter of the OG-JPN
documentation
------------------------------------------------------------------------
"""
...
ss_path = (
    "/Users/tatsurukkuchi/OG-JPN/run_examples/"
    + "OUTPUT_BASELINE_CLOSED/SS/SS_vars.pkl"
)
tpi_path = (
    "/Users/tatsurukikuchi/OG-JPN/run_examples/"
